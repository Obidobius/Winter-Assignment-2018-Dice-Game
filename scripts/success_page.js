...
// This function collects the remaining local.Storage of the player that reached the goal tile with an if else statement.
function showWinner() {
...
// This sections contains the canvas ( the right side of the website) displaying the text.
function draw() {
